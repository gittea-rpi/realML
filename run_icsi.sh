...
####################################################
echo 'SparsePCA  -- LL1_736_population_spawn_MIN_METADATA - pipeline 6'
####################################################
id_run="${sparsepcaPipeline6_id}_run"
path_1="$sparsepcaPipeline6_path/pipelines/$sparsepcaPipeline6_id.json"
path_2="../datasets/seed_datasets_current/LL1_736_population_spawn_simpler_MIN_METADATA/LL1_736_population_spawn_simpler_MIN_METADATA_problem/problemDoc.json"
path_3="../datasets/seed_datasets_current/LL1_736_population_spawn_simpler_MIN_METADATA/LL1_736_population_spawn_simpler_MIN_METADATA_dataset/datasetDoc.json"
path_4="../datasets/seed_datasets_current/LL1_736_population_spawn_simpler_MIN_METADATA/TEST/dataset_TEST/datasetDoc.json"
path_5="../datasets/seed_datasets_current/LL1_736_population_spawn_simpler_MIN_METADATA/SCORE/dataset_SCORE/datasetDoc.json"
