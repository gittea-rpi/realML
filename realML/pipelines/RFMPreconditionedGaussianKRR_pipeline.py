...
class RFMPreconditionedGaussianKRRPipeline(BasePipeline):
    ...
    def _gen_pipeline(self):
        ...
        pipeline = d3m_pipeline.Pipeline(context = d3m_pipeline.PipelineContext.TESTING)
        ...
        step_0.add_argument(
                name = 'inputs',
                argument_type = d3m_pipeline.ArgumentType.CONTAINER,
        ...
        step_2.add_hyperparameter(
                name='semantic_types',
                argument_type=d3m_pipeline.ArgumentType.VALUE,
        ...
        step_4.add_argument(name='inputs', argument_type=d3m_pipeline.ArgumentType.CONTAINER, data_reference='steps.1.produce')
