...
class TensorMachinesRegularizedLeastSquaresPipeline_26_radon_seed(BasePipeline):
    def __init__(self):
        super().__init__()
    ...
    def _gen_pipeline(self):
        ...
        #step 8: call TensorMachinesRegularizedLeastSquares for regression
        step_8 = d3m_pipeline.PrimitiveStep(primitive_description=TensorMachinesRegularizedLeastSquares.metadata.query())
        step_8.add_argument(
                name='inputs',
                argument_type=d3m_base.ArgumentType.CONTAINER,
...
if __name__ == '__main__':
	instance = TensorMachinesRegularizedLeastSquaresPipeline_26_radon_seed()
