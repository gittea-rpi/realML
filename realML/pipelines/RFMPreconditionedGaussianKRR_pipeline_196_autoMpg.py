...
class RFMPreconditionedGaussianKRRPipeline_196_autoMpg(BasePipeline):
    def __init__(self):
        super().__init__()
    ...
    def _gen_pipeline(self):
        ...
        step_9 = d3m_pipeline.PrimitiveStep(primitive_description=RFMPreconditionedGaussianKRR.metadata.query())
        step_9.add_argument(
                name='inputs',
                argument_type=d3m_base.ArgumentType.CONTAINER,
        ...
        #step 11: generate a properly-formatted output dataframe from the dataframed prediction outputs using the input dataframe as a reference
...
if __name__ == '__main__':
	instance = RFMPreconditionedGaussianKRRPipeline_196_autoMpg()
